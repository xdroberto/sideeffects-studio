...
export default function PrivacyPage() {
  return (
    <Container id="main-content" width="prose" as="main" className="min-h-screen bg-black text-white py-24 md:py-32">
      ...
      <h1 className="text-display-md mb-2">Privacy Policy</h1>
      <p className="text-gray-500 text-sm mb-12">Last updated: March 2026</p>

      <div className="space-y-8 text-gray-300 leading-relaxed">
        <section>
          <h2 className="text-display-sm text-white mb-3">Data Collection</h2>
          <p>
        ...
        <section>
          <h2 className="text-display-sm text-white mb-3">Third-Party Services</h2>
          <p>
        ...
        <section>
          <h2 className="text-display-sm text-white mb-3">Hosting</h2>
          <p>
        ...
        <section>
          <h2 className="text-display-sm text-white mb-3">External Links</h2>
          <p>
